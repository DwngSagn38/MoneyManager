...
class IncomeAnalyticFragment: BaseFragment<FragmentExpenseAnalyticBinding>() {
    ...
    private val categories = listOf(
        ExpenseCategory("Transportation", 1100f, Color.parseColor("#627BFF"), R.drawable.ic_expenses),
        ExpenseCategory("Pets", 600f, Color.parseColor("#FF6F91"), R.drawable.ic_loans),
        ExpenseCategory("Education", 260f, Color.parseColor("#46D9F3"), R.drawable.ic_income)
    )
